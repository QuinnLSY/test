...
while True:  # 不断训练刷新画布
    ...
    for i in range(27, 670, 44):
        ...
        if i == 27 or i == 670 - 27:  # 边缘线稍微粗一些
            pygame.draw.line(screen, line_color, [i, 26], [i, 670 - 26], 4)
        else:
    ...
    if check_over_pos(x, y, over_pos):  # 判断是否可以落子，再显示
        # pygame.draw.rect(screen, [255, 0, 0], [x - 22, y - 22, 44, 44], 2, 1)  # 屏幕，[坐标，长宽]，粗细，实:0虚:1
        pygame.draw.line(screen, [255, 0, 0], (x - 22, y - 22), (x - 11, y - 22), 2)
        pygame.draw.line(screen, [255, 0, 0], (x - 22, y - 22), (x - 22, y - 11), 2)

        pygame.draw.line(screen, [255, 0, 0], (x - 22, y + 20), (x - 11, y + 20), 2)
        pygame.draw.line(screen, [255, 0, 0], (x - 22, y + 21), (x - 22, y + 10), 2)

        pygame.draw.line(screen, [255, 0, 0], (x + 21, y - 22), (x + 10, y - 22), 2)
        pygame.draw.line(screen, [255, 0, 0], (x + 20, y - 22), (x + 20, y - 11), 2)

        pygame.draw.line(screen, [255, 0, 0], (x + 20, y + 21), (x + 20, y + 10), 2)
        pygame.draw.line(screen, [255, 0, 0], (x + 20, y + 20), (x + 9, y + 20), 2)


    # 获取鼠标按键信息
    keys_pressed = pygame.mouse.get_pressed()
    # 鼠标左键表示落子,tim用来延时的，因为每次循环时间间隔很短，容易导致明明只按了一次左键，却被多次获取，认为我按了多次
    ...
    pygame.draw.rect(screen, [0, 255, 0], [m - 22, n - 22, 44, 44], 2, 1)
